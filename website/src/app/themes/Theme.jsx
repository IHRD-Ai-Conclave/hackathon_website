...
function Theme() {
  return (
    ...
    <div className='w-screen h-screen flex flex-col justify-center items-center bg-[#003399]'>
      
      <div className='w-screen h-;40vh] flex flex-col md:flex-row gap-10 md:gap-0  justify-around items-center'>
    
        {themeData.map((theme, index) => (
          <div key={index} className='bg-[#67cb34] rounded-lg p-6 flex flex-col items-center w-screen h-full justify-between md:w-[20vw] '>
